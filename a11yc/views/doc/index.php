...
<?php /* ?>
	...
	<?php
		echo '<a role="button" tabindex="0" data-narrow-level="l_a,l_aa,l_aaa" class="current">'.A11YC_LANG_CTRL_ALL.'</a>';
		for ($i=1; $i<=3; $i++)
		{
...
<?php
$msg = A11YC_LANG_DOC_SEARCH_RESULT_NONE;
...
$msg = '';
?>
<h2><?php echo A11YC_LANG_DOC_TEST ?></h2>
...
?>
	...
	<?php
	 foreach ($yml['guidelines'] as $kk => $vv):
		...
		if (substr($kk, 0, 1) != (string) $k) continue;
?>
