...
<textarea id="a11yc_add_pages" name="pages" rows="7" style="width: 100%;"><?php echo Util::s($crawled) ?></textarea>
...
<input type="text" name="get_urls" id="a11yc_get_urls" size="60" value="<?php echo Util::s($get_urls) ?>" />
